...
const testFileRegexp = /^([^:]*):(\d+):(\d+):\s+[\dxabcdef]*\s+in\s+test\.(.*)\s+\(test\)$/; // matches '/Users/hz/Downloads/w/zig/zig-study/src/root.zig:29:5: 0x102044ec3 in test.add 2 (test)'
const otherFileRegexp = /^([^:]*):(\d+):(\d+):\s+[\dxabcdef]*\s+(.*)$/; // matches '/Users/hz/Downloads/w/zig/zig-study/src/root.zig:46:10: 0x104c90fe7 in second (test)'
const buildRegexp = /^(\S.*):(\d*):(\d*):\s(\w*):*\s(.*)$/; // matches 'src/root.zig:33:19: error: error is ignored'
